...
class LeadView extends Component {
    ...
    render() {
        const { text, claps, title, feature_img, author } = this.props._lead
                        ...
                        <div className="post-stats clearfix">
                            <div className="pull-left">
                                <div className="like-button-wrapper">
                                    <button onClick={() => this.props.clap(this.props._lead._id)} className="like-button" data-behavior="trigger-overlay" type="submit">
